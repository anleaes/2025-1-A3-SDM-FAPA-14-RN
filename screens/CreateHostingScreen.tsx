...
type Props = DrawerScreenProps<DrawerParamList, "CreateHosting">;

const CreateHostingScreen = ({ navigation }: Props) => {
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    await fetch("http://localhost:8000/hospedagens/", {
      method: "POST",
...
export default CreateHostingScreen;
